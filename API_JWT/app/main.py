...
class UsuarioCreate(BaseModel):
    ...
    nombre: str = Field(..., min_length=3, max_length=50, example="Estrella Marco")
    edad: int = Field(..., ge=1, le=123, description="Edad válida entre 1 - 100")
